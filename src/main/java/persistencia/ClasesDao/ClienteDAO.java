 ...
 * operaciones necesarias con la base de datos que afecten a los clientes como
 * registrar a un cliente, permitir que el cliente se registre, ofrecerle un
 * metodo para que recupere su contraseña, permitir que actualice su numero de
 * telefono y su correo electronico y obtener los datos del cliente. Se utiliza
 * la clase SQLiteManager para concectarse a la base de datos.
 *
...
public class ClienteDAO {
     ...
     * datos.
     *
     * @param cliente, representa a un objeto cliente, el cual contiene los
     * datos a registrar.
    ...
    /**
     * Se encarga de revisar que el usuario y la contraseña ingresados sean
     * validos, en caso que sea asi, permite el acceso.
     *
     ...
     * en caso de que de que el usuario y la contraseña sean validos, si no
     * devuelve un objeto vacio.
     */
    public Cliente loginQuery(String user,
            String password) {
     ...
     * @return Devuelve la contraseña de un cliente en caso de que el correo
     * electronico sea valido o un mensaje avisando que no encontro el correo.
     */
    ...
    /**
     * Actualiza el correo del cliente en la base de datos. Verifica que el
     * correo electronico actual este en la base de datos y el nuevo correo
     * electronico tenga un @ y no este en la base de datos.
     *
     * @param correoNuevo representa el nuevo correo electronico.
     * @param id representa el numero de identificacion del cliente.
     * @return true en caso de se haya podido actualizar correctamente el
     * correo, false en caso contrario.
     */
    public boolean actualizarCorreo(int id,
            String correoNuevo) {
    ...
    /**
     * Actualiza el numero de telefono del cliente en la base de datos. Verifica
     * que el correo este en la base de datos y que el nuevo telefono no
     * coincida con el numero de telefono de alguien más.
     *
     ...
     * correo, false en caso contrario.
     */
    public boolean actualizarTelefono(int id,
            String telefono) {
        boolean actualizacion = false;
    ...
    /**
     * Este método se encarga de buscar en la base de datos el nombre, correo y
     * teléfono de un cliente a través de su id, devolviendo un arreglo de
     * String con esos valores.
     *
     * @param id es el id que corresponde al cliente.
     * @return un arreglo de String con la siguiente información:
     * -datosCliente[0]: nombre del cliente. -datosCliente[1]: correo
     * electronico del cliente. -datosCliente[2]: teléfono del cliente.
     */
    ...
    /**
     * Se encarga de obtener una lista de todos los clientes en la base de
     * datos.
     *
