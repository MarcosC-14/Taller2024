...
public class Mesa {
    ...
    /**
     * Contructor de mesa para el numero, capacidad, ubicacion y listado de
     * reservas
     *
     * @param numero el numero que identifica la mesa.
     * @param capacidad que indica cuantas personas maximo se pueden sentar en
    ...
    /**
     * Metodo que se encarga de crear un listado de reservas en caso de no
     * existir y agrega una nueva reserva al listado
     *
